...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="content-header"><div class="container-fluid"><div class="row mb-2"><div class="col"><h1 class="m-0 text-dark">Stok Masuk</h1></div></div></div></div>
...
<div class="modal fade" id="modal"><div class="modal-dialog"><div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group"><label>Keterangan</label><select name="keterangan" class="form-control" onchange="checkKeterangan(this)"><option value="penambahan">Penambahan</option><option value="lain">Lain</option></select></div>
      <div class="form-group supplier"><label>Supplier</label><select name="supplier" class="form-control select2" id="supplier"></select></div>
      <div class="form-group lain d-none"><label>Lain</label><input type="text" class="form-control" placeholder="Lain"></div>
...
<script>
  var readUrl = '<?= site_url('stok_masuk/read') ?>';
  var addUrl = '<?= site_url('stok_masuk/add') ?>';
  var getBarcodeUrl = '<?= site_url('produk/get_barcode') ?>';
  var supplierSearchUrl = '<?= site_url('supplier/search') ?>';
</script>
<script src="<?= base_url('assets/js/unminify/stok_masuk.js?v=8') ?>"></script>
</body>
</html>
