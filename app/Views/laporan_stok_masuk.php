...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="content-header"><div class="container-fluid"><div class="row mb-2"><div class="col"><h1 class="m-0 text-dark">Laporan Stok Masuk</h1></div></div></div></div>
    <section class="content">
      <div class="container-fluid"><div class="card"><div class="card-body">
        <table class="table w-100 table-bordered table-hover" id="laporan_stok_masuk">
          <thead><tr><th>No</th><th>Tanggal</th><th>Barcode</th><th>Nama Produk</th><th>Jumlah</th><th>Keterangan</th><th>Supplier</th></tr></thead>
        </table>
      </div></div></div>
    </section>
  </div>
...
<script>
  var laporanUrl = '<?= site_url('stok_masuk/laporan') ?>';
</script>
<script src="<?= base_url('assets/js/unminify/laporan_stok_masuk.js?v=8') ?>"></script>
</body>
</html>
