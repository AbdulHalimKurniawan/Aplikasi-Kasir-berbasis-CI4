...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="content-header"><div class="container-fluid"><div class="row mb-2"><div class="col"><h1 class="m-0 text-dark">Kategori Produk</h1></div></div></div></div>
      ...
      <div class="container-fluid"><div class="card">
        ...
        <div class="card-body">
          <table class="table w-100 table-bordered table-hover" id="kategori_produk">
            <thead><tr><th>No</th><th>Kategori</th><th>Actions</th></tr></thead>
          </table>
        </div>
      </div></div>
    </section>
...
<div class="modal fade" id="modal"><div class="modal-dialog"><div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group"><label>Kategori</label><input type="text" class="form-control" placeholder="Kategori" name="kategori" required></div>
...
<script>
  var readUrl = '<?= site_url('kategori_produk/read') ?>';
  var addUrl = '<?= site_url('kategori_produk/add') ?>';
  var deleteUrl = '<?= site_url('kategori_produk/delete') ?>';
  var editUrl = '<?= site_url('kategori_produk/edit') ?>';
  var get_kategoriUrl = '<?= site_url('kategori_produk/get_kategori') ?>';
</script>
<script src="<?= base_url('assets/js/unminify/kategori_produk.js?v=8') ?>"></script>
</body>
</html>
