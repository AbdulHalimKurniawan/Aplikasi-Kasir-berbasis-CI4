...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="content-header"><div class="container-fluid"><div class="row mb-2"><div class="col"><h1 class="m-0 text-dark">Satuan Produk</h1></div></div></div></div>
      ...
      <div class="container-fluid"><div class="card">
        ...
        <div class="card-body">
          <table class="table w-100 table-bordered table-hover" id="satuan_produk">
            <thead><tr><th>No</th><th>Satuan</th><th>Actions</th></tr></thead>
          </table>
        </div>
      </div></div>
    </section>
...
<div class="modal fade" id="modal"><div class="modal-dialog"><div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group"><label>Satuan</label><input type="text" class="form-control" placeholder="Satuan" name="satuan" required></div>
...
<script>
  var readUrl = '<?= site_url('satuan_produk/read') ?>';
  var addUrl = '<?= site_url('satuan_produk/add') ?>';
  var removeUrl = '<?= site_url('satuan_produk/delete') ?>';
  var editUrl = '<?= site_url('satuan_produk/edit') ?>';
  var get_satuanUrl = '<?= site_url('satuan_produk/get_satuan') ?>';
</script>
<script src="<?= base_url('assets/js/unminify/satuan_produk.js?v=8') ?>"></script>
</body>
</html>
