...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="content-header"><div class="container-fluid"><div class="row mb-2"><div class="col"><h1 class="m-0 text-dark">Pengguna</h1></div></div></div></div>
      ...
      <div class="container-fluid"><div class="card">
        ...
        <div class="card-body">
          <table class="table w-100 table-bordered table-hover" id="pengguna">
            <thead><tr><th>No</th><th>Username</th><th>Nama</th><th>Actions</th></tr></thead>
          </table>
        </div>
      </div></div>
    </section>
...
<div class="modal fade" id="modal"><div class="modal-dialog"><div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group"><label>Username</label><input type="text" class="form-control" placeholder="Username" name="username" required></div>
      <div class="form-group"><label>Password</label><input type="password" class="form-control" placeholder="Password" name="password" required></div>
...
<script>
  var readUrl = '<?= site_url('pengguna/read') ?>';
  var addUrl = '<?= site_url('pengguna/add') ?>';
  var deleteUrl = '<?= site_url('pengguna/delete') ?>';
  var editUrl = '<?= site_url('pengguna/edit') ?>';
  var getPenggunaUrl = '<?= site_url('pengguna/get_pengguna') ?>';
</script>
<script src="<?= base_url('assets/js/unminify/pengguna.js?v=8') ?>"></script>
</body>
</html>
