...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="content-header"><div class="container-fluid"><div class="row mb-2"><div class="col"><h1 class="m-0 text-dark">Laporan Stok Keluar</h1></div></div></div></div>
...
<script src="<?= base_url('assets/js/unminify/laporan_stok_keluar.js?v=8') ?>"></script>
</body>
</html>
